...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    // how do we keep track of 81 different text fields ? without create them
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.rgb(0, 191, 235);
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(144, 240, 241);
    private static final String SUDOKU = "Судоку";
    ...
    private void styleSudokuTile(SudokuTextField tile, double x, double y) {
        ...
        tile.setBackground(javafx.scene.layout.Background.EMPTY);
